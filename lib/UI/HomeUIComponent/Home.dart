import 'package:sistem_monitoring/Library/carousel_pro/carousel_pro.dart';
import 'package:flutter/material.dart';
import 'package:sistem_monitoring/ListItem/HomeGridItemRecomended.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/AppbarGradient.dart';
import 'package:sistem_monitoring/Library/countdown/countdown.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/CategoryDetail.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/DetailProduct.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/FlashSale.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/MenuDetail.dart';
import 'package:sistem_monitoring/UI/HomeUIComponent/PromotionDetail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    var imageSlider = Container(
      ...
      child: new Carousel(
        ...
        images: [
          AssetImage("assets/img/lapor1.png"),
          AssetImage("assets/img/lapor2.png"),
          AssetImage("assets/img/lapor3.png"),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          CategoryIconValue(
            ...
            icon1: "assets/icon/menu.png",
            title1: "Menu",
            tap2: onClickMenuIcon,
            icon2: "assets/icon/merger2.png",
            title2: "Antrian",
            tap3: onClickMenuIcon,
            icon3: "assets/icon/advertising.png",
            title3: "Info Penting",
            tap4: onClickMenuIcon,
            icon4: "assets/icon/document.png",
            title4: "Dokumen",
          ),
          Padding(padding: EdgeInsets.only(top: 23.0)),
          CategoryIconValue(
            icon1: "assets/icon/directive_board.png",
            tap1: onClickMenuIcon,
            title1: "Tahapan",
            icon2: "assets/icon/progress_bar.png",
            tap2: onClickMenuIcon,
            title2: "Status",
            icon3: "assets/icon/help.png",
            tap3: onClickMenuIcon,
            title3: "Bantuan",
            icon4: "assets/icon/more_horizontal.png",
            tap4: onClickMenuIcon,
            title4: "Lainnya",
          ),
          Padding(padding: EdgeInsets.only(top: 23.0)),
              ...
              children: <Widget>[
                Padding(
                    padding: EdgeInsets.only(
                        top: mediaQueryData.padding.top + 75.5)),
