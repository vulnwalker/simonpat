                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Center(
                                  /// Animation text Simon Raja Ampat accept from splashscreen layout (Click to open code)
                                  child: Hero(
                                    tag: "Treva",
                                    child: Text(
                                      "Simon Raja Ampat",
                                ...
                                /// Padding Text "Get best product in Simon Raja Ampat" (Click to open code)
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: 160.0,
                                        right: 160.0,
                                ...
                                Text(
                                  "Get best product in Simon Raja Ampat",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 17.0,
